...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_ad_rotator_layout_zone" AS ENUM('header', 'sidebar', 'content', 'footer');
  CREATE TYPE "public"."enum_pages_blocks_ad_rotator_placement" AS ENUM('top-left', 'top-right', 'bottom-left', 'bottom-right');
  CREATE TYPE "public"."enum_pages_blocks_ad_rotator_tracking_provider" AS ENUM('google-ads', 'ga4', 'facebook-ads', 'facebook-pixel', 'linkedin-ads', 'microsoft-ads', 'hubspot', 'twitter-ads', 'tiktok-ads', 'snapchat-ads', 'pinterest-ads', 'amazon-dsp', 'adobe-advertising', 'custom');
  CREATE TYPE "public"."enum_pages_blocks_banner_style" AS ENUM('info', 'warning', 'error', 'success');
  CREATE TYPE "public"."enum_pages_blocks_cta_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_pages_blocks_cta_links_link_appearance" AS ENUM('default', 'outline');
  CREATE TYPE "public"."enum_pages_blocks_content_with_media_content_position" AS ENUM('Left', 'Right');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_ad_rotator_layout_zone" AS ENUM('header', 'sidebar', 'content', 'footer');
  CREATE TYPE "public"."enum__pages_v_blocks_ad_rotator_placement" AS ENUM('top-left', 'top-right', 'bottom-left', 'bottom-right');
  CREATE TYPE "public"."enum__pages_v_blocks_ad_rotator_tracking_provider" AS ENUM('google-ads', 'ga4', 'facebook-ads', 'facebook-pixel', 'linkedin-ads', 'microsoft-ads', 'hubspot', 'twitter-ads', 'tiktok-ads', 'snapchat-ads', 'pinterest-ads', 'amazon-dsp', 'adobe-advertising', 'custom');
  CREATE TYPE "public"."enum__pages_v_blocks_banner_style" AS ENUM('info', 'warning', 'error', 'success');
  CREATE TYPE "public"."enum__pages_v_blocks_cta_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum__pages_v_blocks_cta_links_link_appearance" AS ENUM('default', 'outline');
  CREATE TYPE "public"."enum__pages_v_blocks_content_with_media_content_position" AS ENUM('Left', 'Right');
  ...
  CREATE TYPE "public"."enum_posts_blocks_ad_rotator_layout_zone" AS ENUM('header', 'sidebar', 'content', 'footer');
  CREATE TYPE "public"."enum_posts_blocks_ad_rotator_placement" AS ENUM('top-left', 'top-right', 'bottom-left', 'bottom-right');
  CREATE TYPE "public"."enum_posts_blocks_ad_rotator_tracking_provider" AS ENUM('google-ads', 'ga4', 'facebook-ads', 'facebook-pixel', 'linkedin-ads', 'microsoft-ads', 'hubspot', 'twitter-ads', 'tiktok-ads', 'snapchat-ads', 'pinterest-ads', 'amazon-dsp', 'adobe-advertising', 'custom');
  ...
  CREATE TYPE "public"."enum_posts_blocks_content_with_media_content_position" AS ENUM('Left', 'Right');
  ...
  CREATE TYPE "public"."enum__posts_v_blocks_ad_rotator_layout_zone" AS ENUM('header', 'sidebar', 'content', 'footer');
  CREATE TYPE "public"."enum__posts_v_blocks_ad_rotator_placement" AS ENUM('top-left', 'top-right', 'bottom-left', 'bottom-right');
  CREATE TYPE "public"."enum__posts_v_blocks_ad_rotator_tracking_provider" AS ENUM('google-ads', 'ga4', 'facebook-ads', 'facebook-pixel', 'linkedin-ads', 'microsoft-ads', 'hubspot', 'twitter-ads', 'tiktok-ads', 'snapchat-ads', 'pinterest-ads', 'amazon-dsp', 'adobe-advertising', 'custom');
  ...
  CREATE TYPE "public"."enum__posts_v_blocks_content_with_media_content_position" AS ENUM('Left', 'Right');
  ...
  CREATE TYPE "public"."enum_ads_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_ads_cta_style" AS ENUM('primary-button', 'secondary-button', 'outline-button', 'text-link', 'underlined-link');
  CREATE TYPE "public"."enum_ads_cta_size" AS ENUM('sm', 'md', 'lg');
  CREATE TYPE "public"."enum_ads_cta_position" AS ENUM('bottom-left', 'bottom-center', 'bottom-right', 'center-left', 'center', 'center-right', 'top-left', 'top-center', 'top-right');
  CREATE TYPE "public"."enum_ads_campaign_provider" AS ENUM('google-ads', 'ga4', 'facebook-ads', 'facebook-pixel', 'linkedin-ads', 'microsoft-ads', 'hubspot', 'twitter-ads', 'tiktok-ads', 'snapchat-ads', 'pinterest-ads', 'amazon-dsp', 'adobe-advertising', 'custom');
  ...
  CREATE TYPE "public"."enum_header_type" AS ENUM('none', 'highImpact', 'mediumImpact', 'lowImpact');
  ...
  CREATE TABLE "pages_blocks_ad_rotator" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar,
  	"layout_zone" "enum_pages_blocks_ad_rotator_layout_zone" DEFAULT 'content',
  	"placement" "enum_pages_blocks_ad_rotator_placement" DEFAULT 'top-left',
  	"rotation_interval" numeric DEFAULT 5000,
  	"pause_on_hover" boolean DEFAULT true,
  	"show_navigation" boolean DEFAULT true,
  	"tracking_enabled" varchar DEFAULT 'false',
  	"tracking_provider" "enum_pages_blocks_ad_rotator_tracking_provider",
  	"tracking_custom_provider" varchar,
  	"tracking_campaign_id" varchar,
  	"tracking_utm_source" varchar,
  	"tracking_utm_medium" varchar,
  	"tracking_custom_code" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "pages_blocks_content_with_media" (
  	...
  	"content" jsonb,
  	"image_id" integer,
  	"content_below_image" jsonb,
  	"content_position" "enum_pages_blocks_content_with_media_content_position",
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_ad_rotator" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"title" varchar,
  	"layout_zone" "enum__pages_v_blocks_ad_rotator_layout_zone" DEFAULT 'content',
  	"placement" "enum__pages_v_blocks_ad_rotator_placement" DEFAULT 'top-left',
  	"rotation_interval" numeric DEFAULT 5000,
  	"pause_on_hover" boolean DEFAULT true,
  	"show_navigation" boolean DEFAULT true,
  	"tracking_enabled" varchar DEFAULT 'false',
  	"tracking_provider" "enum__pages_v_blocks_ad_rotator_tracking_provider",
  	"tracking_custom_provider" varchar,
  	"tracking_campaign_id" varchar,
  	"tracking_utm_source" varchar,
  	"tracking_utm_medium" varchar,
  ...
  CREATE TABLE "_pages_v_blocks_content_with_media" (
  	...
  	"image_id" integer,
  	"content_below_image" jsonb,
  	"content_position" "enum__pages_v_blocks_content_with_media_content_position",
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "posts_blocks_ad_rotator" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar,
  	"layout_zone" "enum_posts_blocks_ad_rotator_layout_zone" DEFAULT 'content',
  	"placement" "enum_posts_blocks_ad_rotator_placement" DEFAULT 'top-left',
  	"rotation_interval" numeric DEFAULT 5000,
  	"pause_on_hover" boolean DEFAULT true,
  	"show_navigation" boolean DEFAULT true,
  	"tracking_enabled" varchar DEFAULT 'false',
  	"tracking_provider" "enum_posts_blocks_ad_rotator_tracking_provider",
  	"tracking_custom_provider" varchar,
  	"tracking_campaign_id" varchar,
  	"tracking_utm_source" varchar,
  	"tracking_utm_medium" varchar,
  ...
  CREATE TABLE "posts_blocks_content_with_media" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	...
  	"image_id" integer,
  	"content_below_image" jsonb,
  	"content_position" "enum_posts_blocks_content_with_media_content_position",
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_posts_v_blocks_ad_rotator" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"title" varchar,
  	"layout_zone" "enum__posts_v_blocks_ad_rotator_layout_zone" DEFAULT 'content',
  	"placement" "enum__posts_v_blocks_ad_rotator_placement" DEFAULT 'top-left',
  	"rotation_interval" numeric DEFAULT 5000,
  	"pause_on_hover" boolean DEFAULT true,
  	"show_navigation" boolean DEFAULT true,
  	"tracking_enabled" varchar DEFAULT 'false',
  	"tracking_provider" "enum__posts_v_blocks_ad_rotator_tracking_provider",
  	"tracking_custom_provider" varchar,
  	"tracking_campaign_id" varchar,
  	"tracking_utm_source" varchar,
  	"tracking_utm_medium" varchar,
  ...
  CREATE TABLE "_posts_v_blocks_content_with_media" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	...
  	"image_id" integer,
  	"content_below_image" jsonb,
  	"content_position" "enum__posts_v_blocks_content_with_media_content_position",
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "ads_campaign_goals" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "ads" (
  	...
  	"content" varchar,
  	"link_type" "enum_ads_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar NOT NULL,
  	"cta_enabled" boolean DEFAULT false,
  	"cta_text" varchar,
  	"cta_style" "enum_ads_cta_style" DEFAULT 'primary-button',
  	"cta_size" "enum_ads_cta_size" DEFAULT 'md',
  	"cta_position" "enum_ads_cta_position" DEFAULT 'bottom-center',
  	"cta_custom_colors_background" varchar,
  	"cta_custom_colors_text" varchar,
  	"cta_custom_colors_border" varchar,
  	"weight" numeric DEFAULT 1,
  	"start_date" timestamp(3) with time zone,
  	"end_date" timestamp(3) with time zone,
  	"seo_alt_text" varchar,
  	"seo_title" varchar,
  	"seo_description" varchar,
  	"campaign_provider" "enum_ads_campaign_provider",
  	"campaign_custom_provider" varchar,
  	"campaign_campaign_id" varchar,
  	"campaign_ad_group_id" varchar,
  	"campaign_ad_id" varchar,
  ...
  CREATE TABLE "header" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"rich_text" jsonb,
  	"type" "enum_header_type" DEFAULT 'lowImpact' NOT NULL,
  	"media_id" integer,
  ...
  ALTER TABLE "pages_blocks_ad_rotator" ADD CONSTRAINT "pages_blocks_ad_rotator_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "pages_rels" ADD CONSTRAINT "pages_rels_ads_fk" FOREIGN KEY ("ads_id") REFERENCES "public"."ads"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_rels" ADD CONSTRAINT "pages_rels_categories_fk" FOREIGN KEY ("categories_id") REFERENCES "public"."categories"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_version_hero_links" ADD CONSTRAINT "_pages_v_version_hero_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_ad_rotator" ADD CONSTRAINT "_pages_v_blocks_ad_rotator_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_rels" ADD CONSTRAINT "_pages_v_rels_ads_fk" FOREIGN KEY ("ads_id") REFERENCES "public"."ads"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_rels" ADD CONSTRAINT "_pages_v_rels_categories_fk" FOREIGN KEY ("categories_id") REFERENCES "public"."categories"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "posts_blocks_ad_rotator" ADD CONSTRAINT "posts_blocks_ad_rotator_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."posts"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "posts_blocks_content_with_media" ADD CONSTRAINT "posts_blocks_content_with_media_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "posts_blocks_content_with_media" ADD CONSTRAINT "posts_blocks_content_with_media_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."posts"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "posts_rels" ADD CONSTRAINT "posts_rels_ads_fk" FOREIGN KEY ("ads_id") REFERENCES "public"."ads"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_posts_v_blocks_ad_rotator" ADD CONSTRAINT "_posts_v_blocks_ad_rotator_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_posts_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_posts_v_blocks_content_with_media" ADD CONSTRAINT "_posts_v_blocks_content_with_media_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_posts_v_blocks_content_with_media" ADD CONSTRAINT "_posts_v_blocks_content_with_media_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_posts_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_posts_v_rels" ADD CONSTRAINT "_posts_v_rels_ads_fk" FOREIGN KEY ("ads_id") REFERENCES "public"."ads"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "ads_tags" ADD CONSTRAINT "ads_tags_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."ads"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "ads_campaign_goals" ADD CONSTRAINT "ads_campaign_goals_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."ads"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "ads_rels" ADD CONSTRAINT "ads_rels_pages_fk" FOREIGN KEY ("pages_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "ads_rels" ADD CONSTRAINT "ads_rels_posts_fk" FOREIGN KEY ("posts_id") REFERENCES "public"."posts"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_ad_rotator_order_idx" ON "pages_blocks_ad_rotator" USING btree ("_order");
  CREATE INDEX "pages_blocks_ad_rotator_parent_id_idx" ON "pages_blocks_ad_rotator" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_ad_rotator_path_idx" ON "pages_blocks_ad_rotator" USING btree ("_path");
  ...
  CREATE INDEX "pages_rels_ads_id_idx" ON "pages_rels" USING btree ("ads_id");
  CREATE INDEX "pages_rels_categories_id_idx" ON "pages_rels" USING btree ("categories_id");
  CREATE INDEX "_pages_v_version_hero_links_order_idx" ON "_pages_v_version_hero_links" USING btree ("_order");
  CREATE INDEX "_pages_v_version_hero_links_parent_id_idx" ON "_pages_v_version_hero_links" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_ad_rotator_order_idx" ON "_pages_v_blocks_ad_rotator" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_ad_rotator_parent_id_idx" ON "_pages_v_blocks_ad_rotator" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_ad_rotator_path_idx" ON "_pages_v_blocks_ad_rotator" USING btree ("_path");
  ...
  CREATE INDEX "_pages_v_rels_ads_id_idx" ON "_pages_v_rels" USING btree ("ads_id");
  CREATE INDEX "_pages_v_rels_categories_id_idx" ON "_pages_v_rels" USING btree ("categories_id");
  CREATE INDEX "posts_blocks_ad_rotator_order_idx" ON "posts_blocks_ad_rotator" USING btree ("_order");
  CREATE INDEX "posts_blocks_ad_rotator_parent_id_idx" ON "posts_blocks_ad_rotator" USING btree ("_parent_id");
  CREATE INDEX "posts_blocks_ad_rotator_path_idx" ON "posts_blocks_ad_rotator" USING btree ("_path");
  ...
  CREATE INDEX "posts_blocks_content_with_media_order_idx" ON "posts_blocks_content_with_media" USING btree ("_order");
  CREATE INDEX "posts_blocks_content_with_media_parent_id_idx" ON "posts_blocks_content_with_media" USING btree ("_parent_id");
  CREATE INDEX "posts_blocks_content_with_media_path_idx" ON "posts_blocks_content_with_media" USING btree ("_path");
  CREATE INDEX "posts_blocks_content_with_media_image_idx" ON "posts_blocks_content_with_media" USING btree ("image_id");
  ...
  CREATE INDEX "posts_rels_ads_id_idx" ON "posts_rels" USING btree ("ads_id");
  CREATE INDEX "posts_rels_pages_id_idx" ON "posts_rels" USING btree ("pages_id");
  CREATE INDEX "posts_rels_posts_id_idx" ON "posts_rels" USING btree ("posts_id");
  CREATE INDEX "posts_rels_categories_id_idx" ON "posts_rels" USING btree ("categories_id");
  CREATE INDEX "posts_rels_users_id_idx" ON "posts_rels" USING btree ("users_id");
  CREATE INDEX "_posts_v_blocks_ad_rotator_order_idx" ON "_posts_v_blocks_ad_rotator" USING btree ("_order");
  CREATE INDEX "_posts_v_blocks_ad_rotator_parent_id_idx" ON "_posts_v_blocks_ad_rotator" USING btree ("_parent_id");
  CREATE INDEX "_posts_v_blocks_ad_rotator_path_idx" ON "_posts_v_blocks_ad_rotator" USING btree ("_path");
  ...
  CREATE INDEX "_posts_v_blocks_content_with_media_order_idx" ON "_posts_v_blocks_content_with_media" USING btree ("_order");
  CREATE INDEX "_posts_v_blocks_content_with_media_parent_id_idx" ON "_posts_v_blocks_content_with_media" USING btree ("_parent_id");
  CREATE INDEX "_posts_v_blocks_content_with_media_path_idx" ON "_posts_v_blocks_content_with_media" USING btree ("_path");
  CREATE INDEX "_posts_v_blocks_content_with_media_image_idx" ON "_posts_v_blocks_content_with_media" USING btree ("image_id");
  ...
  CREATE INDEX "_posts_v_rels_ads_id_idx" ON "_posts_v_rels" USING btree ("ads_id");
  ...
  CREATE INDEX "ads_tags_order_idx" ON "ads_tags" USING btree ("_order");
  CREATE INDEX "ads_tags_parent_id_idx" ON "ads_tags" USING btree ("_parent_id");
  CREATE INDEX "ads_campaign_goals_order_idx" ON "ads_campaign_goals" USING btree ("_order");
  CREATE INDEX "ads_campaign_goals_parent_id_idx" ON "ads_campaign_goals" USING btree ("_parent_id");
  ...
  CREATE INDEX "ads_rels_pages_id_idx" ON "ads_rels" USING btree ("pages_id");
  CREATE INDEX "ads_rels_posts_id_idx" ON "ads_rels" USING btree ("posts_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_ad_rotator" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_ad_rotator" CASCADE;
  ...
  DROP TABLE "_posts_v_blocks_ad_rotator" CASCADE;
  ...
  DROP TABLE "_posts_v_blocks_content_with_media" CASCADE;
  ...
  DROP TABLE "ads_tags" CASCADE;
  DROP TABLE "ads_campaign_goals" CASCADE;
  ...
  DROP TYPE "public"."enum_pages_blocks_ad_rotator_layout_zone";
  DROP TYPE "public"."enum_pages_blocks_ad_rotator_placement";
  DROP TYPE "public"."enum_pages_blocks_ad_rotator_tracking_provider";
  DROP TYPE "public"."enum_pages_blocks_banner_style";
  DROP TYPE "public"."enum_pages_blocks_cta_links_link_type";
  DROP TYPE "public"."enum_pages_blocks_cta_links_link_appearance";
  DROP TYPE "public"."enum_pages_blocks_content_with_media_content_position";
  ...
  DROP TYPE "public"."enum__pages_v_blocks_ad_rotator_layout_zone";
  DROP TYPE "public"."enum__pages_v_blocks_ad_rotator_placement";
  DROP TYPE "public"."enum__pages_v_blocks_ad_rotator_tracking_provider";
  DROP TYPE "public"."enum__pages_v_blocks_banner_style";
  DROP TYPE "public"."enum__pages_v_blocks_cta_links_link_type";
  DROP TYPE "public"."enum__pages_v_blocks_cta_links_link_appearance";
  DROP TYPE "public"."enum__pages_v_blocks_content_with_media_content_position";
  ...
  DROP TYPE "public"."enum_posts_blocks_ad_rotator_layout_zone";
  DROP TYPE "public"."enum_posts_blocks_ad_rotator_placement";
  DROP TYPE "public"."enum_posts_blocks_ad_rotator_tracking_provider";
  ...
  DROP TYPE "public"."enum_posts_blocks_content_with_media_content_position";
  ...
  DROP TYPE "public"."enum__posts_v_blocks_ad_rotator_layout_zone";
  DROP TYPE "public"."enum__posts_v_blocks_ad_rotator_placement";
  DROP TYPE "public"."enum__posts_v_blocks_ad_rotator_tracking_provider";
  ...
  DROP TYPE "public"."enum__posts_v_blocks_content_with_media_content_position";
  ...
  DROP TYPE "public"."enum_ads_link_type";
  DROP TYPE "public"."enum_ads_cta_style";
  DROP TYPE "public"."enum_ads_cta_size";
  DROP TYPE "public"."enum_ads_cta_position";
  DROP TYPE "public"."enum_ads_campaign_provider";
